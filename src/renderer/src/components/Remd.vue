  ...
  <div class="remd">
    ...
    <div class="top">
      ...
      <div class="time">
        ...
        <div class="date">{{ SetTime.Hour }}:{{ SetTime.Min }}:{{ SetTime.Sec }}</div>
      </div>

      <div class="rightImg1">
        <ul style="list-style: none">
          <li v-for="item in bigImg.data" style="float: left">
